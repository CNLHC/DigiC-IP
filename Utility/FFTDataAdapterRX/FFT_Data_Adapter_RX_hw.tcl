...
set_module_property NAME FFT_Data_Adapter_RX
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP DigiC/Utility
set_module_property AUTHOR CNLHC
set_module_property DISPLAY_NAME "FFT Data Format Adapter RX"
...
set_fileset_property synth_fileset TOP_LEVEL FFTDataAdapter_RX
...
proc generate {entity_name} {
	...
	set tWLeft [expr [get_parameter_value EXTRA_LEFT_PADDING] ]
	set tWRight [expr [get_parameter_value EXTRA_RIGHT_PADDING] ]
    set fileID [open "./FFTDataAdapter_RX.v" r]
    set temp ""
    while {[eof $fileID] != 1} {
    ...
    add_fileset_file FFTDataAdapter_RX.v VERILOG TEXT $temp
}
