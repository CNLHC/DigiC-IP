...
set_module_property NAME Fix_Length_Bytes2Packets_RX
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP DigiC/Utility
set_module_property AUTHOR CNLHC
set_module_property DISPLAY_NAME "Fix Length Bytes To Packet RX"
...
set_fileset_property synth_fileset TOP_LEVEL FixLengthB2P_RX
...
proc generate {entity_name} {
	...
	set tSymbolLength [expr [get_parameter_value BYTES_PER_SYMBOL] ]
	set tBytesLength  [expr [get_parameter_value BITS_PER_BYTES] ]
    set fileID [open "./FixLengthB2P_RX.v" r]
    set temp ""
    while {[eof $fileID] != 1} {
    ...
    add_fileset_file FixLengthB2P_RX.v VERILOG TEXT $temp
}
